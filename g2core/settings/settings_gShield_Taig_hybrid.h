/*
 * settings_gShield_Taig.h - machine profile for Taig Mill via gShield on Arduino Due,
 * X axis using hybrid stepper via D31 step, D32 dir
 * A axis using ordinary stepper via gShield X channel
...
#define SPINDLE_SPEED_MAX       10000.0     // {spsm:
#endif
...
#define M1_TRAVEL_PER_REV           (360/90)                // {1tr:  90:1 gear ratio
#endif
...
#define M2_TRAVEL_PER_REV           (360.0/90.0)
#endif
...
#define M3_TRAVEL_PER_REV           1.27                    // 1.25 is a typical value for a screw axis
#endif
...
#define M4_TRAVEL_PER_REV           1.27                   // in degrees if rotary axis (ABC)
#endif
...
#endif
#ifndef X_TRAVEL_MIN
#define X_TRAVEL_MIN                -369.0                  // {xtn:  minimum travel for soft limits
#endif
#ifndef X_TRAVEL_MAX
...
#define X_HOMING_INPUT              5                       // {xhi:  input used for homing or 0 to disable
#endif
...
#define X_LATCH_BACKOFF             3.0                     // {xlb:  mm
#endif
...
#define Z_VELOCITY_MAX              250.0
#endif
#ifndef Z_FEEDRATE_MAX
#define Z_FEEDRATE_MAX              250.0
#endif
#ifndef Z_TRAVEL_MAX
#define Z_TRAVEL_MAX                0.0
#endif
#ifndef Z_TRAVEL_MIN
#define Z_TRAVEL_MIN                -128.0
#endif
#ifndef Z_JERK_MAX
...
#endif
#ifndef A_TRAVEL_MAX
#define A_TRAVEL_MAX                  360
#endif
#ifndef A_JERK_MAX
#define A_JERK_MAX                  500.0    // 1000 works but there is little benefit to it
#endif
...
#define A_LATCH_BACKOFF             10.0  // If you go less than 10, repeated g28.2a0 does not return to the same place.  The sensor spans about 10 degrees.
#endif
...
// Amax
#ifndef DI8_MODE
#define DI8_MODE                    IO_ACTIVE_HIGH     // Normally closed
#endif
#ifndef DI8_ACTION
...
#define P1_CW_PHASE_LO             0.42                  // phase [0..1]
#endif
