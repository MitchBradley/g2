...
pin_number kSocket2_EnablePinNumber         =  8;
...
pin_number kSocket3_EnablePinNumber         =  8;
...
pin_number kSocket5_StepPinNumber           = 39;
...
pin_number kSocket6_StepPinNumber           = 31;
pin_number kSocket6_DirPinNumber            = 29;
pin_number kSocket6_EnablePinNumber         = 25;  // 27:limit
...
pin_number kInput1_PinNumber =  9; // unused
pin_number kInput2_PinNumber = 11; // unused
pin_number kInput3_PinNumber = 12; // unused
pin_number kInput4_PinNumber = 49; // Probe
pin_number kInput5_PinNumber = 43; // kSocket4 limit
pin_number kInput6_PinNumber = 35; // kSocket5 limit
pin_number kInput7_PinNumber = 27; // kSocket6 limit
pin_number kInput8_PinNumber = 22; // A axis homing. D23 and D24 seem to be broken, always reading high
pin_number kInput9_PinNumber = 13; // unused
pin_number kInput10_PinNumber = 59; // unused
pin_number kInput11_PinNumber = 60; // unused
pin_number kInput12_PinNumber = 61; // unused

pin_number kSpindle_EnablePinNumber = 51;
pin_number kSpindle_DirPinNumber    = -1;
pin_number kSpindle_PwmPinNumber    = 53;
pin_number kSpindle_Pwm2PinNumber   = -1;
pin_number kCoolant_EnablePinNumber = 24;
