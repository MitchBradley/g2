...
pin_number kSocket1_EnablePinNumber         = -1;   // Workaround for kGRBL_CommonEnablePinNumber not working (22 is default value)
...
pin_number kInput1_PinNumber = 13;
pin_number kInput2_PinNumber = 12;
pin_number kInput3_PinNumber = 11;
pin_number kInput4_PinNumber = 9;
pin_number kInput5_PinNumber = 14;
pin_number kInput6_PinNumber = 15;

pin_number kInput7_PinNumber  = 16;
pin_number kInput8_PinNumber  = 17;
pin_number kInput9_PinNumber  = 58;
pin_number kInput10_PinNumber = 59;
pin_number kInput11_PinNumber = 60;
pin_number kInput12_PinNumber = 61;

pin_number kSpindle_EnablePinNumber = 10;
